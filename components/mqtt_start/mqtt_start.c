...
static void mqtt_app_start(esp_mqtt_client_handle_t *client_handle)
{
    esp_mqtt_client_config_t mqtt_cfg = {
        .uri = "mqtt://192.168.200.164",
    };
...
void mqtt_start(esp_mqtt_client_handle_t *client_handle)
{
