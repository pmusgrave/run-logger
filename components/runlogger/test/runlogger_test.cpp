...
TEST_CASE("Runlogger stop button", "[runlogger]") {
	...
	test_logger.handle_stop_button();
	TEST_ASSERT_EQUAL(STOPPED, test_logger.get_state());
	TEST_ASSERT_EQUAL(1, test_logger.current_run.get_duration());
	...
	esp_light_sleep_start();
	TEST_ASSERT_EQUAL(PAUSED, test_logger.get_state());
	TEST_ASSERT_EQUAL(2, test_logger.current_run.get_duration());
	test_logger.handle_stop_button();
	esp_sleep_enable_timer_wakeup(1000000LL);
	esp_light_sleep_start();
	TEST_ASSERT_EQUAL(2, test_logger.current_run.get_duration());
	...
	TEST_ASSERT_EQUAL(last_run2.get_duration(), test_run->get_duration());
	...
	esp_light_sleep_start();
	TEST_ASSERT_EQUAL(PAUSED, test_logger.get_state());
	TEST_ASSERT_EQUAL(3, test_logger.current_run.get_duration());
	test_logger.handle_stop_button();
	esp_sleep_enable_timer_wakeup(1000000LL);
	esp_light_sleep_start();
	TEST_ASSERT_EQUAL(3, test_logger.current_run.get_duration());
	...
	TEST_ASSERT_EQUAL(last_run3.get_duration(), test_run->get_duration());
	...
	test_logger.handle_stop_button();
	TEST_ASSERT_EQUAL(STOPPED, test_logger.get_state());
	TEST_ASSERT_EQUAL(4, test_logger.current_run.get_duration());
	...
	TEST_ASSERT_EQUAL(last_run4.get_duration(), test_run->get_duration());
