...
static void uart_rx_task(void* arg) {
    ...
    while (1) {
        ...
        while (line != NULL) {
            switch (minmea_sentence_id((const char*)data, false)) {
                case MINMEA_SENTENCE_RMC: {
                    struct minmea_sentence_rmc frame;
                    if (minmea_parse_rmc(&frame, (const char*)data)) {
                ...
                case MINMEA_SENTENCE_GGA: {
                    ...
                    if (minmea_parse_gga(&frame, (const char*)data)) {
                ...
                case MINMEA_SENTENCE_GST: {
                    ...
                    if (minmea_parse_gst(&frame, (const char*)data)) {
                ...
                case MINMEA_SENTENCE_GSV: {
                    ...
                    if (minmea_parse_gsv(&frame, (const char*)data)) {
                ...
                case MINMEA_SENTENCE_VTG: {
                   ...
                   if (minmea_parse_vtg(&frame, (const char*)data)) {
                ...
                case MINMEA_SENTENCE_ZDA: {
                    ...
                    if (minmea_parse_zda(&frame, (const char*)data)) {
